...
Check out the live demo: https://movierecomend.herokuapp.com/
...
1. Install all the libraries mentioned in the [requirements.txt](https://github.com/ahtesham11/Movie-Recommendation-System-with-Sentiment-Analysis/blob/master/requirements.txt) file.
